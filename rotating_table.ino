...
void loop() {
  ...
  //--------------------------------------------------------------
    ...
    val1_n = map(val1,0,1023,0,400);
  
    //Read Pausing-time Pot
    val2 =analogRead(POT2_PIN);
    val2_n = map(val2,0,1023,0,1500);
    ...
    Serial.print("Speed: "); Serial.print(val1_n);
    Serial.print("    Pause: "); Serial.print(val2_n);
    Serial.print("    Direction: "); Serial.print(sw1_n);
    Serial.println(" ");
